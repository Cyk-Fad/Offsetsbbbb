...
{
//signatures
 constexpr ::std::ptrdiff_t m_fFirstHook = 0xB17E0;
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB1820;
constexpr ptrdiff_t fakeLevel = 0x51F023C;
constexpr ptrdiff_t fakeRank = 0xCFBA0001;
...
constexpr ptrdiff_t dwEntityList = 0x4D9EAD4;
constexpr ptrdiff_t dwForceAttack = 0x31D0034;
constexpr ptrdiff_t dwForceAttack2 = 0x31D0040;
constexpr ptrdiff_t dwForceBackward = 0x31D0088;
constexpr ptrdiff_t dwForceForward = 0x31D0094;
constexpr ptrdiff_t dwForceJump = 0x5248A34;
constexpr ptrdiff_t dwForceLeft = 0x31D0010;
constexpr ptrdiff_t dwForceRight = 0x31D0004;
constexpr ptrdiff_t dwGameDir = 0x62C7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52BBD2C;
constexpr ptrdiff_t dwGetAllClasses = 0xDAEC94;
constexpr ptrdiff_t dwGlobalVars = 0x58DCE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52E70D0;
constexpr ptrdiff_t dwInput = 0x51F00B8;
constexpr ptrdiff_t dwInterfaceLinkList = 0x943644;
...
constexpr ptrdiff_t dwPlayerResource = 0x31CE390;
constexpr ptrdiff_t dwRadarBase = 0x51D384C;
...
constexpr ptrdiff_t dwViewMatrix = 0x4D903D4;
constexpr ptrdiff_t dwWeaponTable = 0x51F0B78;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xCFBA0002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD91CD0;
constexpr ptrdiff_t dwbSendPackets = 0xD70FA;
...
constexpr ptrdiff_t m_pitchClassPtr = 0x51D3AE8;
...
constexpr ptrdiff_t is_c4_owner = 0x3BAC50;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AE162;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x3071ED20;
