...
constexpr ::std::ptrdiff_t m_fSecondHook = 0xBF140
constexpr ptrdiff_t fakeLevel = 0x51F019C;
constexpr ptrdiff_t fakeRank = 0xCFD90001;
...
constexpr ptrdiff_t dwEntityList = 0x4D9EA34;
constexpr ptrdiff_t dwForceAttack = 0x31CFF94;
constexpr ptrdiff_t dwForceAttack2 = 0x31CFFA0;
constexpr ptrdiff_t dwForceBackward = 0x31CFFE8;
constexpr ptrdiff_t dwForceForward = 0x31CFFF4;
constexpr ptrdiff_t dwForceJump = 0x5248994;
constexpr ptrdiff_t dwForceLeft = 0x31CFF70;
constexpr ptrdiff_t dwForceRight = 0x31CFF64;
constexpr ptrdiff_t dwGameDir = 0x62C7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52BBC8C;
constexpr ptrdiff_t dwGetAllClasses = 0xDAEBE4;
constexpr ptrdiff_t dwGlobalVars = 0x58DCE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52E7020;
constexpr ptrdiff_t dwInput = 0x51F0018;
constexpr ptrdiff_t dwInterfaceLinkList = 0x943064;
...
constexpr ptrdiff_t dwPlayerResource = 0x31CE2F0;
constexpr ptrdiff_t dwRadarBase = 0x51D37AC;
...
constexpr ptrdiff_t dwViewMatrix = 0x4D90334;
constexpr ptrdiff_t dwWeaponTable = 0x51F0AD8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xCFD90002;
...
constexpr ptrdiff_t m_pitchClassPtr = 0x51D3A48;
...
constexpr ptrdiff_t is_c4_owner = 0x3BABA0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AE0C2;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x3052ED20;
