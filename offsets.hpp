...
{
//signatures
constexpr ptrdiff_t fakeLevel = 0x51F56E4;
constexpr ptrdiff_t fakeRank = 0xD5E90001;
constexpr ptrdiff_t dwClientState = 0x588FE4;
...
constexpr ptrdiff_t dwEntityList = 0x4DA3F9C;
constexpr ptrdiff_t dwForceAttack = 0x31D54DC;
constexpr ptrdiff_t dwForceAttack2 = 0x31D54E8;
constexpr ptrdiff_t dwForceBackward = 0x31D5530;
constexpr ptrdiff_t dwForceForward = 0x31D553C;
constexpr ptrdiff_t dwForceJump = 0x524DEDC;
constexpr ptrdiff_t dwForceLeft = 0x31D5554;
constexpr ptrdiff_t dwForceRight = 0x31D5548;
constexpr ptrdiff_t dwGameDir = 0x6277F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52C11BC;
constexpr ptrdiff_t dwGetAllClasses = 0xDB3F8C;
constexpr ptrdiff_t dwGlobalVars = 0x588CE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52EC580;
constexpr ptrdiff_t dwInput = 0x51F5560;
constexpr ptrdiff_t dwInterfaceLinkList = 0x946F44;
constexpr ptrdiff_t dwLocalPlayer = 0xD8C2BC;
constexpr ptrdiff_t dwMouseEnable = 0xD91E60;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD91E30;
constexpr ptrdiff_t dwPlayerResource = 0x31D3850;
constexpr ptrdiff_t dwRadarBase = 0x51D8D14;
constexpr ptrdiff_t dwSensitivity = 0xDA32CC;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA32A0;
constexpr ptrdiff_t dwSetClanTag = 0x8A1B0;
constexpr ptrdiff_t dwViewMatrix = 0x4D958B4;
constexpr ptrdiff_t dwWeaponTable = 0x51F6020;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xD5E90002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD96D60;
...
constexpr ptrdiff_t m_yawClassPtr = 0xD91AC0;
constexpr ptrdiff_t m_pitchClassPtr = 0x51D8FB0;
...
constexpr ptrdiff_t model_ambient_min = 0x58C05C;
constexpr ptrdiff_t set_abs_angles = 0x1DF9C0;
constexpr ptrdiff_t set_abs_origin = 0x1DF800;
constexpr ptrdiff_t is_c4_owner = 0x3BAF00;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AE412;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x2A42E320;
