...
namespace offsets
{
constexpr ::std::string m_szShowMessage = [2020.11.5];
constexpr ::std::ptrdiff_t m_fFirstHook = 0xB14B0;
constexpr ::std::ptrdiff_t m_fSecondHook = 0xB14F0;
	
//signatures
constexpr ptrdiff_t fakeLevel = 0x51A3AF4;
constexpr ptrdiff_t fakeRank = 0xCF9A0001;
...
constexpr ptrdiff_t dwSensitivity = 0xD54C74;
constexpr ptrdiff_t dwSensitivityPtr = 0xD54C48;
...
constexpr ptrdiff_t dwYawPtr = 0xCF9A0002;
...
constexpr ptrdiff_t find_hud_element = 0x30911BE0;
