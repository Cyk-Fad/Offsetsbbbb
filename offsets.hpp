...
{
//signatures
constexpr ptrdiff_t m_fFirstHook = 0xB1A60;
constexpr ptrdiff_t m_fSecondHook = 0xB1AA0;
constexpr ptrdiff_t fakeLevel = 0x51F457C;
constexpr ptrdiff_t fakeRank = 0xD0580001;
...
constexpr ptrdiff_t dwEntityList = 0x4DA2E14;
constexpr ptrdiff_t dwForceAttack = 0x31D43A4;
constexpr ptrdiff_t dwForceAttack2 = 0x31D43B0;
constexpr ptrdiff_t dwForceBackward = 0x31D435C;
constexpr ptrdiff_t dwForceForward = 0x31D4368;
constexpr ptrdiff_t dwForceJump = 0x524CD74;
constexpr ptrdiff_t dwForceLeft = 0x31D4380;
constexpr ptrdiff_t dwForceRight = 0x31D4374;
constexpr ptrdiff_t dwGameDir = 0x62D7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52C005C;
constexpr ptrdiff_t dwGetAllClasses = 0xDB2D7C;
constexpr ptrdiff_t dwGlobalVars = 0x58ECE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52EB3F8;
constexpr ptrdiff_t dwInput = 0x51F43F8;
constexpr ptrdiff_t dwInterfaceLinkList = 0x945994;
...
constexpr ptrdiff_t dwPlayerResource = 0x31D26D0;
constexpr ptrdiff_t dwRadarBase = 0x51D7B8C;
constexpr ptrdiff_t dwSensitivity = 0xDA216C;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA2140;
constexpr ptrdiff_t dwSetClanTag = 0x8A1A0;
constexpr ptrdiff_t dwViewMatrix = 0x4D94714;
constexpr ptrdiff_t dwWeaponTable = 0x51F4EB8;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xD0580002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD95D60;
constexpr ptrdiff_t dwbSendPackets = 0xD73CA;
...
constexpr ptrdiff_t m_pitchClassPtr = 0x51D7E28;
...
constexpr ptrdiff_t is_c4_owner = 0x3BAD80;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AE2C2;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x2FD3EED0;
