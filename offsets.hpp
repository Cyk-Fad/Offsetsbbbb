...
{
//signatures
constexpr ptrdiff_t fakeLevel = 0x51F133C;
constexpr ptrdiff_t fakeRank = 0xCCE90001;
...
constexpr ptrdiff_t dwEntityList = 0x4D9FBD4;
constexpr ptrdiff_t dwForceAttack = 0x31D1134;
constexpr ptrdiff_t dwForceAttack2 = 0x31D1140;
constexpr ptrdiff_t dwForceBackward = 0x31D1188;
constexpr ptrdiff_t dwForceForward = 0x31D1194;
constexpr ptrdiff_t dwForceJump = 0x5249B34;
constexpr ptrdiff_t dwForceLeft = 0x31D1110;
constexpr ptrdiff_t dwForceRight = 0x31D1104;
constexpr ptrdiff_t dwGameDir = 0x62D7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52BCE2C;
constexpr ptrdiff_t dwGetAllClasses = 0xDAFD74;
constexpr ptrdiff_t dwGlobalVars = 0x58ECE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52E81B0;
constexpr ptrdiff_t dwInput = 0x51F11B8;
constexpr ptrdiff_t dwInterfaceLinkList = 0x943C54;
constexpr ptrdiff_t dwLocalPlayer = 0xD882BC;
constexpr ptrdiff_t dwMouseEnable = 0xD8DE60;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD8DE30;
constexpr ptrdiff_t dwPlayerResource = 0x31CF490;
constexpr ptrdiff_t dwRadarBase = 0x51D494C;
constexpr ptrdiff_t dwSensitivity = 0xD9F16C;
constexpr ptrdiff_t dwSensitivityPtr = 0xD9F140;
constexpr ptrdiff_t dwSetClanTag = 0x8A1A0;
constexpr ptrdiff_t dwViewMatrix = 0x4D914D4;
constexpr ptrdiff_t dwWeaponTable = 0x51F1C78;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xCCE90002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD92D60;
constexpr ptrdiff_t dwbSendPackets = 0xD723A;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_yawClassPtr = 0xD8DAC0;
constexpr ptrdiff_t m_pitchClassPtr = 0x51D4BE8;
...
constexpr ptrdiff_t set_abs_angles = 0x1E05B0;
constexpr ptrdiff_t set_abs_origin = 0x1E03F0;
constexpr ptrdiff_t is_c4_owner = 0x3BACB0;
constexpr ptrdiff_t force_update_spectator_glow = 0x3AE1F2;
constexpr ptrdiff_t anim_overlays = 0x2980;
constexpr ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ptrdiff_t find_hud_element = 0x3342EE80;
